...
function HomePage() {
    ...
    return (
        <div className="max-h-screen overflow-y-scroll snap snap-y snap-mandatory">
            <section
                className="flex items-center justify-center w-full h-screen snap-start flex-col"
                id="portfolio"
            >
                <div className="w-full h-20" id="vide"></div>
                <div className="my-auto px-5 space">
                    <h2 className="text-3xl font-extralight lg:text-5xl 2xl:text-7xl">
                        Bonjour !
                    </h2>
                    <h1 className="pt-8 text-5xl lg:text-7xl 2xl:text-8xl text-yellow-400 font-thin">
                        Nous sommes des développeurs web.
                    </h1>
                </div>
                <div className="my-auto">
                    <ul className="grid gap-6 w-full md:grid-cols-2 xl:gap-10 2xl:gap-16">
                        <li>
                            ...
                            <label
                                htmlFor="adrien"
                                className="inline-flex justify-between items-center p-5 w-full text-gray-500 bg-white rounded-lg border border-gray-200 cursor-pointer select-none
                            ...
                            >
                                <div className="block">
                                    <div className="w-full text-lg font-semibold lg:text-2xl 2xl:text-4xl">
                                        Adrien
                                    </div>
                                    <div className="w-full lg:text-xl 2xl:text-3xl">
                                        Blair
                                    </div>
                                </div>
                                <div className="relative  overflow-hidden w-32 h-32 -right-12 lg:w-56 lg:h-56 lg:-right-24 2xl:w-80 2xl:h-80 2xl:-right-28">
                                    <Image
                                        ...
                                        className=" -right-9 rounded-full shadow-lg  "
                                        layout="fill"
                                    ></Image>
                                </div>
                            </label>
                        ...
                        <li>
                            ...
                            >
                                ...
                                <div className="relative  overflow-hidden w-32 h-32 -right-12 lg:w-56 lg:h-56 lg:-right-24 2xl:w-80 2xl:h-80 2xl:-right-28">
                                    <Image
                                        src="/aurelien.png"
                                        alt="Photo de profil d'Aurelien"
                                        className=" -right-9 rounded-full shadow-lg  "
                                        layout="fill"
                                    ></Image>
                                </div>
