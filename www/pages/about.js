...
function About() {
    return (
        <section id="about" className="flex items-center justify-between flex-col w-full h-screen  bg-background dark:bg-dark_background">
            <div className="w-full mt-12" id="vide"></div>
            <div className="p-5">
                <div className="space-y-6">
                    <h1 className="pt-8 text-3xl font-extralight lg:text-5xl 2xl:text-7xl text-yellow-400">À propos</h1>
                    <div className="space-y-4">
                        ...
                        <p className="text-justify">
                            ...
                            <b>React</b> est un framework JavaScript libre développé par Facebook depuis 2013. Il est utilisé pour développer des interfaces utilisateur, et permet de créer des applications web monopages. <br></br>
                            <br></br>
                            Le contenu créé pour les TP 1 à 3 est disponible dans le dossier <a href="https://github.com/Ahddry/ece-webapp-blair-bon/tree/main/server">server</a>, la suite dont nous parlons dans cette documentation est quant à elle
                            dispnible dans le dossier <a href="https://github.com/Ahddry/ece-webapp-blair-bon/tree/main/www">www</a>.
                        </p>
                        ...
                        <p className="text-justify">
                            Pour compléter cette application, nous avons décidé d'y rajouter une couche d'<b>HTML</b> et de <b>CSS</b> à plusieurs thèmes, s'adaptant ainsi aux préférences de couleurs de l'utilisateur (clair ou sombre) afin d'en
                            améliorer le rendu et la fluidité de navigation.<br></br>
